...
class ContinuationPredictor(nn.Module):
    """
    Predicts the probability that the episode continues (not done) given the encoded state and predicted next state (both latent vectors).
    ...
    Output:
        - Tensor of shape (B,) (probability of continuation)
    """
    ...
    def forward(self, x):
        ...
        Returns:
            (B,) tensor of probability of continuation
        """
